...
| ID | Slice | Status | PR |
|----|-------|--------|-----|
| R0 | Release pipeline green on main (Actions PR perms + sync resilience) | In progress | #5 sync + follow-up |
| P0a | CI hard-gates: Bun IPC + native dylib (no soft-skip) | Pending | — |
