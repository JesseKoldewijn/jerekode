...
4. Parity board is closed ([docs/roadmap-parity.md](docs/roadmap-parity.md)); for packaging / releases work use [docs/roadmap-releases.md](docs/roadmap-releases.md) and [ADR 003](docs/adr/003-release-packaging-and-changelogs.md). First-party RTK dual adapter: [ADR 004](docs/adr/004-rtk-dual-adapter.md) / `packages/rtk`.
