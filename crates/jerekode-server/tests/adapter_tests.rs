...
use jerekode_core::{Session, SessionId, SessionStatus};
use jerekode_server::adapters::normalized;
use jerekode_server::adapters::v1::{
    V1CreateSessionRequest, denormalize_create_session, denormalize_send_message,
    normalize_create_session,
};
use jerekode_server::adapters::v2::{
...
fn v1_send_message_response_content_from_fixture() {
    ...
    let assistant = jerekode_core::Message {
        role: jerekode_core::MessageRole::Assistant,
