...
| CLI smoke | `jerekode version` + `jerekode serve` v1/v2 session create (binary e2e); full OpenCode CLI mirror tracked in [roadmap-parity-cli.md](docs/roadmap-parity-cli.md) (locked decisions + pending clarifications) |
...
Active CLI parity plan (full mirror locked): [docs/roadmap-parity-cli.md](docs/roadmap-parity-cli.md).  
